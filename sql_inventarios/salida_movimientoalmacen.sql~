...
BEGIN
    ...
    EXECUTE 'SELECT "Id_DocumentoMovimiento", "Id_ConceptoDocumento", "Id_ClaveFolio", "Id_Usuario", "Id_UbicacionFisica1", "Id_UbicacionFisica2" FROM "Documento" INNER JOIN "Detalle_Documento" ON "Documento"."ID"="Detalle_Documento"."Id_Documento" WHERE "Documento"."ID" =' || id_documento INTO id_movimiento, id_concepto, id_clavefolio, id_usuario, id_ubicacionfisica1, id_ubicacionfisica2;
